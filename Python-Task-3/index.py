...
while True:
    ...
    if(choice.isdigit() == True):
        if(choice == "1"):
            ...
            print("Your Account Created Successfully \nHere is your Acc No: {}".format(gen_acc_no));
            ...
            if(view_acc_no in whole_data):
                ...
                print("Here is your balance: Rs. {}/-".format(whole_data[view_acc_no][1]));
            ...
            if(deposit_acc_no in whole_data):
                ...
                print("Your account credited with {}\nCurrent balance Rs. {}/-".format(deposit, new_data));
            else:
            ...
            if(withdraw_acc_no in whole_data):
                ...
                if(whole_data[withdraw_acc_no][1] >= withdraw):
                    ...
                    print("Your account debited with {}\nCurrent balance Rs. {}/-".format(withdraw, new_data));
                else:
